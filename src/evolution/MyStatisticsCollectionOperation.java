 ...
 * @author erikhemberg
 */
public class MyStatisticsCollectionOperation extends StatisticsCollectionOperation{
    ...
    private static final String OUTPUT_COLUMNS = "#BEST FT averageFitness averageUsedGeneLength time invalids varFitness aveLength aveDerivationTreeDepth";
    private static final String OUTPUT_COLUMNS_STDOUT = "G\tFIT EVAL\tTime(ms)\tBestFit\tAveFit\tVarFit\tAveUsedGenes\tAveLength\tAveDTDepth";
     ...
     */
    public MyStatisticsCollectionOperation(StatCatcher stats, IndividualCatcher indCatch) {
        super(stats, indCatch);
        this.stats = stats;
     ...
     * @param p properties
     */
    public MyStatisticsCollectionOperation(StatCatcher stats, IndividualCatcher indCatch, Properties p) {
    	super(stats, indCatch, p);
    	this.stats = stats;
        this.indCatch = indCatch;
    ...
    public void printHeader() {
        ...
        System.out.println(MyStatisticsCollectionOperation.OUTPUT_COLUMNS_STDOUT);
    }
...
//   	System.out.println(stats.getCurrentMean()+"\n");
//        System.out.format
//        (   "%1$4d\t%9$5d\t%2$6d\t%3$4d\t%4$6.3f\t%5$6.3f\t%6$8.3f\t%7$6.3f\t%8$6.3f\t%10$6.3f%n",
...
//            );
    ...
    public void printStats() {
	    ...
	    this.fileName = fileName+System.currentTimeMillis();
            ...
            Long start = iT.next();
            Long diff, stop;
            bw.write(MyStatisticsCollectionOperation.OUTPUT_COLUMNS);
            bw.newLine();
            while(ib.hasNext()&&im.hasNext() && iAUG.hasNext() && iT.hasNext() && iInv.hasNext() && iAV.hasNext() && iAL.hasNext() && iAD.hasNext()) {
                ...
                bw.write(iAUG.next()+" "+diff+" "+" "+iAV.next()+" "+iAL.next()+" "+iAD.next());
                bw.newLine();
            }
            bw.close();
            fw.close();            
